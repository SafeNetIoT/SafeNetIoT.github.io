...
t.default=function(){
  var e=(0,i.Z)(l).sort((function(e,t){return new Date(t.date)-new Date(e.date)}));
    ...
    (0,a.jsxs)("div",{className:"d-flex flex-column justify-content-between bg-primary min-vh-100",children:[
      (0,a.jsxs)("div",{className:"py-5 px-5 container",children:[
        ...
        (0,a.jsx)("div",{className:"row",children:e.map((function(e,t){return(0,a.jsx)("div",{className:"col-md-6 col-lg-4 mb-4",children:(0,a.jsxs)("div",{className:"card h-100",children:[
          (0,a.jsx)("img",{src:e.image,alt:"News from ".concat(e.date),className:"card-img-top",style:{height:"200px",objectFit:"cover"}}),
          (0,a.jsxs)("div",{className:"card-body",children:[
            ...
            (0,a.jsx)("a",{href:e.link,className:"btn btn-outline-primary",children:"Learn More"})
          ]})
        ]})},t)}))
      })
    ]}),
