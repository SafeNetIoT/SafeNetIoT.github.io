(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[134],{5115:function(e,t,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/news",function(){return n(3450)}])},3450:function(e,t,n){"use strict";n.r(t),n.d(t,{allNews:function(){return l}});var i=n(797),a=n(5893),s=n(7294),r=n(3193),o=n(7673),c=n(8010),d=n(217),

l=[
  {
    date: "25-28 May 2025 - ISCAS 2025 Presentation",
    sortableDate: "2025-05-25",
    title: "ISCAS 2025 Presentation",
  ...
  },
  {
    ...
    sortableDate: "2025-02-06",
    title: "BBC's Blue Room Visit",
  ...
  },
  {
    ...
    sortableDate: "2025-01-31",
    title: "Visiting Speaker Michele Chiappalone",
  ...
  },
  {
    ...
    sortableDate: "2025-01-08",
    title: "London Networks & Systems Symposium",
  ...
  },
  {
    ...
    title: "EWSN 2024 Best Demo Award",
  ...
  },
  {
    ...
    sortableDate: "2024-11-26",
    title: "Connected Ecosystems Event",
...
t.default=function(){
  var e=(0,i.Z)(l).sort((function(e,t){return new Date(t.sortableDate)-new Date(e.sortableDate)}));
  return(0,a.jsxs)(s.Fragment,{children:[
    (0,a.jsx)(o.h,{seo:d.HJ}),
    (0,a.jsx)(c.J,{title:d.G.name,links:d.G.links}),
    (0,a.jsxs)("div",{className:"d-flex flex-column justify-content-between bg-primary min-vh-100",children:[
      (0,a.jsxs)("div",{className:"py-5 px-5 container",children:[
        (0,a.jsx)("h1",{className:"text-secondary fw-bold text-left mb-5",children:"All News"}),
        (0,a.jsx)("div",{className:"row justify-content-center mb-5",children:(0,a.jsx)("div",{className:"col-12 col-md-10 col-lg-8",children:(0,a.jsxs)("div",{className:"text-secondary lead text-left",children:[
          "The latest updates on our achievements, events, and collaborations.",
          (0,a.jsxs)("ul",{className:"list-unstyled",children:[
            (0,a.jsx)("li",{children:"- Award Wins: Celebrating our recognition for excellence in IoT security research and innovation."}),
            (0,a.jsx)("li",{children:"- Conferences: Highlights of conferences we have organized, attended, or presented at, showcasing our contributions to the global IoT community."}),
            (0,a.jsx)("li",{children:"- Speakers: Insights from renowned experts and thought leaders who have shared their knowledge at our events."})
          ]})
        ]})})}),
        (0,a.jsx)("div",{className:"row",children:e.map((function(e,t){return(0,a.jsx)("div",{className:"col-md-6 col-lg-4 mb-4",children:(0,a.jsxs)("div",{className:"card h-100",children:[
          (0,a.jsx)("img",{src:e.image,alt:e.title || e.date,className:"card-img-top",style:{height:"200px",objectFit:"cover"}}),
          (0,a.jsxs)("div",{className:"card-body",children:[
            (0,a.jsx)("h5",{className:"card-title text-primary",children:e.date}),
            (0,a.jsx)("p",{className:"card-text text-primary",children:e.description}),
            e.link ? (0,a.jsx)("a",{href:e.link,className:"btn btn-outline-primary",children:"Learn More"}) : null
          ]})
        ]})},t)}))
      })
    ]}),
...
}}},function(e){e.O(0,[948,682,217,774,888,179],(function(){return t=5115,e(e.s=t);var t}));var t=e.O();_N_E=t}]);
