...

{
  ...
  description: "PhD candidate Andrew Losty was selected as part of the RACI (RIPE Academic Cooperation Initiative) to present his research at the RIPE 91 Meeting in Bucharest, Romania. He delivered two research presentations.<br><br><strong>Main Plenary Session</strong><br><em>Towards Operational and Security Best Practices for DNS in the Internet of Things</em>, outlining IoT DNS research and progress towards adoption of the IETF BCP <em>IoT DNS Security and Privacy Guidelines</em> (UCL, INRIA and Infoblox).<br><br><strong>IoT Workshop</strong><br><em>Beyond the Hype: Investigating Matter Standard’s Security and Privacy</em>, providing an update on the Matter standard, a security appraisal, and research in progress.",
